...
//add a method to populate sample accts data
	public static Map<Integer, BankAccount> populateAccountMap() {
		...
		System.out.println("Added "
				+ accts.put(101, new BankAccount(101, "Rama", AcType.SAVING, 15000, LocalDate.parse("2023-01-01"))));
		System.out.println("Added "
				+ accts.put(10, new BankAccount(10, "Shubham", AcType.SAVING, 23000, LocalDate.parse("2022-01-01"))));

		System.out.println("Added "
				+ accts.put(15, new BankAccount(15, "Kiran", AcType.FD, 150000, LocalDate.parse("2022-11-01"))));
		...
		System.out.println("Added " + accts.putIfAbsent(34,
				new BankAccount(34, "Mihir2", AcType.SAVING, 14000, LocalDate.parse("2023-09-21"))));
